...
const f = { birthday: "bd", city: "city", hometown: "home", relationshipStatus: "rs",
...
describe("0363", () => {
  it("dates: a full date only when the year is known; gender onto the select's options", () => {
    ...
    expect(isoBirthday("July 4", "1900")).toBe("1900-07-04");
  ...
  it("fills only empty fields; a yearless birthday is stored as 1900; family is added to notes once", () => {
    ...
    expect(set).toEqual({ bd: "1900-05-05", home: "Racine", rs: "Single", g: "male",
  ...
  it("a full birthday fills Birthday with its year", () => {
