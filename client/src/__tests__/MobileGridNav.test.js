/**
 * MobileGridNav.test.js
 *
 * Tests lip button visibility based on grid dimensions and active cell position.
 */
...
// Helper: render MobileGridNav and return rendered lip button aria-labels
...
describe("MobileGridNav lip buttons", () => {
  test("1x1 grid renders no lip buttons", () => {
