...
function InstanceInner({
  ...
  return (
    ...
    >
      ...
      {/* Open this row's link as a browser page in THIS panel. Bottom-right of
          the occurrence for every row, bookmark cards included — there it sits
          over the caption under the picture (see `urlButtonPlacement`). */}
