...
const SYNC_ACTIONS = new Set([
  ActionTypes.CREATE_MODULE,
  ActionTypes.UPDATE_MODULE,
  ActionTypes.DELETE_MODULE,
  ActionTypes.BATCH_UPDATE_MODULES,
  ...
  ActionTypes.CREATE_OPERATION,
  ActionTypes.UPDATE_OPERATION,
